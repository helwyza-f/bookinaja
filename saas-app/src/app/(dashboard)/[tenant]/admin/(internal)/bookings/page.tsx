    ...
    <div className="max-w-7xl mx-auto space-y-8 pb-20 animate-in fade-in duration-700 px-4 mt-10 font-plus-jakarta text-slate-900 dark:text-slate-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className="p-8 rounded-[2.5rem] bg-white dark:bg-slate-900 border-none shadow-xl border border-slate-100 dark:border-white/5 relative overflow-hidden group">
          ...
          <MonitorPlay className="absolute -right-4 -bottom-4 w-24 h-24 text-slate-50 dark:text-white/5 -rotate-12 pointer-events-none group-hover:scale-110 transition-transform z-[-1]" />
        </Card>
      </div>
        ...
        <div className="flex flex-wrap gap-3 w-full lg:w-auto">
          <div className="relative flex-1 lg:w-80">
            ...
            <Input
              ...
              className="pl-11 h-12 rounded-xl border-slate-100 dark:border-white/5 bg-slate-50 dark:bg-slate-800 focus:ring-blue-600 font-bold italic text-xs pr-2"
            />
          </div>
      ...
      <div className="flex flex-wrap items-center gap-3 bg-slate-50/50 dark:bg-slate-900/50 p-4 rounded-3xl border border-slate-100 dark:border-white/5">
        ...
        <Select value={filterStatus} onValueChange={setFilterStatus}>
          <SelectTrigger className="w-[140px] h-10 rounded-xl border-slate-200 dark:border-white/10 bg-white dark:bg-slate-800 font-bold italic text-[10px] uppercase pr-2 dark:text-white">
        ...
        <Select value={filterResource} onValueChange={setFilterResource}>
          <SelectTrigger className="w-[160px] h-10 rounded-xl border-slate-200 dark:border-white/10 bg-white dark:bg-slate-800 font-bold italic text-[10px] uppercase pr-2 dark:text-white">
      ...
      {/* 4. CONTENT AREA */}
      {loading ? (
        <div className="h-96 flex flex-col items-center justify-center gap-4 bg-white dark:bg-slate-900 rounded-[3rem] shadow-sm ring-1 ring-slate-100 dark:ring-white/5">
          <Loader2 className="h-10 w-10 animate-spin text-blue-600/20" />
          <p className="font-black italic text-[11px] text-slate-300 dark:text-slate-600 uppercase tracking-widest pr-2">
            Menyinkronkan Data...
          </p>
        </div>
