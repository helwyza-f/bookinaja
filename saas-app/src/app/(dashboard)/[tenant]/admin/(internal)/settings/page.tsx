...
export default function SettingsPage() {
  ...
  if (!isEditing) {
    return (
      <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20 px-4">
        {/* HEADER SUMMARY CARD */}
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 bg-slate-950 p-10 rounded-[3.5rem] text-white shadow-2xl relative overflow-hidden group">
          ...
          <div className="flex items-center gap-8 relative z-10">
            <div className="h-28 w-28 rounded-3xl bg-white/10 backdrop-blur-xl border border-white/20 overflow-hidden p-2 flex items-center justify-center shadow-2xl transition-transform group-hover:scale-105 duration-500">
              {allData.logo_url ? (
                <img
          ...
          <Button
            ...
            className="rounded-2xl h-16 px-10 bg-white text-black hover:bg-slate-200 font-[1000] uppercase italic tracking-wider transition-all active:scale-95 relative z-10 shadow-xl"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-8">
            <Card className="rounded-[3rem] border-none shadow-sm overflow-hidden bg-white group/banner">
              ...
              <CardContent className="p-10 space-y-10">
                <div className="space-y-3">
                  ...
                  <h2 className="text-4xl font-black italic uppercase leading-tight tracking-tighter text-slate-900">
            ...
            {/* GALLERY PREVIEW */}
            <Card className="rounded-[3rem] border-none shadow-sm p-10 bg-white">
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            {/* SEO SIMULATOR */}
            <Card className="rounded-[3rem] border-none shadow-sm p-8 bg-white space-y-6 overflow-hidden relative group">
            ...
            {/* COLOR MATRIX */}
            <Card className="rounded-[3rem] border-none shadow-sm p-8 bg-white space-y-4">
              <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-blue-600 italic">
                Visual Token
              </h3>
  ...
  return (
    <div className="max-w-6xl mx-auto pb-24 animate-in zoom-in-95 duration-500 px-4">
      {/* STICKY ACTION BAR */}
      <div className="sticky top-6 z-50 flex items-center justify-between bg-white/80 backdrop-blur-xl p-4 rounded-3xl border border-slate-200 shadow-2xl mb-12 animate-in slide-in-from-top-4 duration-700">
        <Button
          variant="ghost"
          onClick={() => setIsEditing(false)}
          className="rounded-2xl gap-2 font-black uppercase italic text-[11px] tracking-widest hover:bg-slate-100"
        >
        ...
        <div className="flex items-center gap-3">
          ...
          <Button
            ...
            disabled={loading}
            className="rounded-2xl h-14 px-10 bg-blue-600 hover:bg-blue-700 font-[1000] italic uppercase tracking-[0.1em] shadow-xl shadow-blue-600/30 active:scale-95 transition-all"
          >
            {loading ? (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-8">
          {/* SECTION: HERO COPY */}
          <Card className="rounded-[3rem] border-none shadow-sm p-10 bg-white space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex gap-3">
                ...
                <Button
                  ...
                  className="h-14 w-14 rounded-2xl bg-blue-600 hover:bg-blue-700 shadow-lg shadow-blue-600/30"
                >
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-3">
                ...
                <Input
                  type="time"
                  {...register("open_time")}
                  className="h-14 rounded-2xl bg-slate-50 border-none font-black px-6 shadow-inner"
                />
              </div>
              <div className="space-y-3">
                <Label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1 italic">
