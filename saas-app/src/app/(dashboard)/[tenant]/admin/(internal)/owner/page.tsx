...
export default function OwnerCommandCenterPage() {
  ...
  return (
    <div className="space-y-6 pb-20">
      <Card className="rounded-[2rem] border-none bg-slate-950 p-6 text-white shadow-2xl overflow-hidden relative">
        ...
        <div className="relative flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div className="space-y-3">
            <Badge className="border-none bg-white/10 text-white text-[9px] font-black uppercase tracking-widest">
          ...
          <div className="flex flex-wrap gap-3">
            <Button asChild className="rounded-2xl bg-white text-slate-950 hover:bg-slate-100 font-black uppercase italic tracking-[0.15em]">
              <Link href="/admin/bookings">
                <CalendarClock className="mr-2 h-4 w-4" />
                Bookings
              </Link>
            </Button>
            <Button asChild variant="outline" className="rounded-2xl border-white/15 bg-white/5 text-white hover:bg-white/10 font-black uppercase italic tracking-[0.15em]">
              <Link href="/admin/pos">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        {[
          ...
          <Card
            key={item.label}
            className="rounded-[1.75rem] border-slate-200 dark:border-white/5 bg-white dark:bg-[#0a0a0a] p-5 shadow-sm"
          >
            <div className="flex items-start justify-between gap-4">
              <div className="space-y-2">
                ...
                {loading ? (
                  <Skeleton className="h-10 w-24 rounded-xl bg-slate-100 dark:bg-white/5" />
                ) : (
                  <div className="text-3xl font-black italic uppercase tracking-tighter dark:text-white">
                    {item.value}
                  </div>
                )}
        ...
        <Card className="rounded-[2rem] border-slate-200 dark:border-white/5 bg-white dark:bg-[#0a0a0a] p-6 md:p-8">
          <div className="flex items-center justify-between gap-4">
            <div>
              ...
              <h3 className="mt-1 text-2xl font-black italic uppercase tracking-tighter dark:text-white">
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {loading ? (
              ...
              <div className="rounded-[1.35rem] border border-dashed border-slate-200 dark:border-white/5 p-8 text-center text-slate-400 font-black uppercase italic tracking-widest sm:col-span-2 lg:col-span-3">
                Belum ada unit
              </div>
            ) : (
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <Badge className={`border text-[9px] font-black uppercase tracking-widest ${statusTone}`}>
        ...
        <div className="space-y-6">
          <Card className="rounded-[2rem] border-slate-200 dark:border-white/5 bg-white dark:bg-[#0a0a0a] p-6 md:p-8">
            <div className="flex items-center justify-between gap-4">
              <div>
                ...
                <h3 className="mt-1 text-xl font-black italic uppercase tracking-tighter dark:text-white">
                  7 hari terakhir
                </h3>
              </div>
                ...
                return (
                  <div key={point.date} className="flex-1 space-y-2">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-[9px] font-black text-slate-900 dark:text-white">
            ...
            <div className="mt-4 text-[10px] font-bold uppercase tracking-[0.25em] text-slate-400">
          ...
          <Card className="rounded-[2rem] border-slate-200 dark:border-white/5 bg-white dark:bg-[#0a0a0a] p-6 md:p-8">
            ...
            <div className="mt-5 space-y-4">
              <div className="flex items-center justify-between rounded-[1.25rem] bg-slate-50 dark:bg-white/5 px-4 py-3">
          ...
          <Card className="rounded-[2rem] border-slate-200 dark:border-white/5 bg-white dark:bg-[#0a0a0a] p-6 md:p-8">
            ...
            <div className="mt-5 space-y-3">
              {loading ? (
                ...
                <div className="rounded-[1.35rem] border border-dashed border-slate-200 dark:border-white/5 p-8 text-center text-slate-400 font-black uppercase italic tracking-widest">
                  Belum ada order
                </div>
              ) : (
                orders.map((order) => (
                  <div
                    key={order.id}
                    className="rounded-[1.25rem] border border-slate-200 dark:border-white/5 bg-slate-50 dark:bg-white/5 p-4"
                  >
                    <div className="flex items-center justify-between gap-3">
                      <div className="min-w-0">
                        ...
                        <div className="mt-1 text-[10px] font-bold uppercase tracking-[0.22em] text-slate-400 truncate">
                    ...
                    <div className="mt-3 flex items-center justify-between text-[10px] font-bold uppercase tracking-[0.22em] text-slate-400">
                      <span>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <Button asChild className="h-12 rounded-2xl bg-blue-600 hover:bg-blue-500 text-white font-black uppercase italic tracking-[0.18em]">
              <Link href="/admin/settings">
                Settings
                <ArrowRight className="ml-2 h-4 w-4" />
              </Link>
            </Button>
            <Button asChild variant="outline" className="h-12 rounded-2xl border-slate-200 bg-white text-slate-950 hover:bg-slate-50 font-black uppercase italic tracking-[0.18em] dark:border-white/10 dark:bg-white/5 dark:text-white">
