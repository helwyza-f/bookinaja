        ...
        {stats.map((item, i) => (
          ...
          >
            <div className="flex justify-between items-start mb-6">
              <div
                className={cn(
                  "h-12 w-12 rounded-2xl bg-slate-50 dark:bg-slate-800 flex items-center justify-center transition-colors group-hover:bg-blue-600/10",
                  item.color,
                )}
              >
              ...
              <Badge
                variant="outline"
                className={cn(
                  "rounded-full border-none px-3 py-1 font-black italic text-[9px] uppercase",
                  item.positive
            ...
            <h3 className="text-3xl font-[1000] italic uppercase tracking-tighter text-slate-900 dark:text-white">
              {item.value}
            </h3>
          </Card>
        ))}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 gap-4">
              {Array.from({ length: 10 }).map((_, i) => (
                <div
                  key={i}
                  className={cn(
                    "aspect-square rounded-3xl p-4 flex flex-col justify-between border-2 transition-all",
                    i < 7
          ...
          <div className="space-y-6">
            {[1, 2, 3, 4, 5].map((item) => (
              ...
              >
                ...
                <p className="text-[10px] font-black italic text-blue-600">
                  5m ago
                </p>
              </div>
            ))}
