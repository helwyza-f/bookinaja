...
export function ManualBookingSkeleton() {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#050505] p-4 lg:p-6 space-y-6 -mt-6">
      <div className="max-w-[1600px] mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <Card className="rounded-[2rem] border-none bg-white dark:bg-[#0c0c0c] p-8 shadow-sm ring-1 ring-black/5 dark:ring-white/5">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                <div className="lg:col-span-4 flex flex-col items-center border-r dark:border-white/5 pr-10 space-y-6">
          ...
          <div className="lg:col-span-4">
            <Card className="rounded-[2.5rem] border-none bg-slate-900 p-8 space-y-8">
