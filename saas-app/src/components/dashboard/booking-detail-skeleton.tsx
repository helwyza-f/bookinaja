...
export function BookingDetailSkeleton() {
  return (
    <div className="max-w-7xl mx-auto p-3 md:p-10 space-y-6 md:space-y-10 font-plus-jakarta animate-pulse">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 md:gap-10">
        ...
        <div className="lg:col-span-7 space-y-6 md:space-y-10">
          {/* INFO CARD */}
          <Card className="rounded-[2rem] md:rounded-[3rem] border-none p-5 md:p-10 bg-white dark:bg-slate-900 space-y-6 md:space-y-10 ring-1 ring-slate-100 dark:ring-white/5">
          ...
          <Card className="rounded-[2rem] md:rounded-[3rem] border-none p-5 md:p-10 bg-white dark:bg-slate-900 space-y-6 md:space-y-8 ring-1 ring-slate-100 dark:ring-white/5">
            <div className="flex justify-between border-b border-slate-100 dark:border-white/5 pb-4 md:pb-6">
        ...
        <div className="lg:col-span-5 space-y-6 md:space-y-10">
          {/* F&B CARD */}
          <Card className="rounded-[2rem] md:rounded-[3rem] border-none p-5 md:p-10 bg-white dark:bg-slate-900 min-h-[400px] ring-1 ring-slate-100 dark:ring-white/5">
            <div className="flex justify-between border-b border-slate-100 dark:border-white/5 pb-4 md:pb-6 mb-6 md:mb-8">
          ...
          <Card className="rounded-[2rem] md:rounded-[3.5rem] border-none bg-slate-950 p-5 md:p-12 space-y-6 md:space-y-10 shadow-xl">
