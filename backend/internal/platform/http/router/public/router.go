...
func Register(r *gin.RouterGroup, cfg routecfg.Config) {
	public := r.Group("/public")
	{
		...
		public.POST("/customer/password/reset/request-email", cfg.CustomerHandler.RequestPasswordResetEmail)
		public.POST("/customer/password/reset/verify-email", cfg.CustomerHandler.VerifyPasswordResetEmail)
		public.POST("/customer/email/verify", cfg.CustomerHandler.VerifyEmail)
