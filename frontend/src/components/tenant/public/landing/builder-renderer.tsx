...
export function getThemeVisuals(theme: LandingThemeConfig) {
  ...
  const presetClassMap: Record<string, { panel: string; card: string; innerPanel: string; badge: string; secondaryButton: string; infoRow: string; empty: string; eyebrow: string; media: string; title: string; heroTitle: string; body: string; strongBody: string; muted: string; eyebrowMuted: string }> = {
    "bookinaja-classic": {
      ...
      badge: "border-slate-200 bg-white/96 text-slate-800 shadow-[0_10px_24px_rgba(15,23,42,0.06)] dark:border-white/10 dark:bg-white/5 dark:text-slate-100",
    ...
    boutique: {
      ...
      badge: "border-stone-200 bg-[#fffaf2]/96 text-stone-800 shadow-[0_10px_24px_rgba(41,37,36,0.07)] dark:border-white/10 dark:bg-[#1b1815] dark:text-stone-100",
    ...
    "sunset-glow": {
      ...
      badge: "border-orange-200 bg-[#fff7ed]/96 text-orange-900 shadow-[0_10px_24px_rgba(124,45,18,0.08)] dark:border-orange-500/20 dark:bg-[#221009] dark:text-orange-100",
    ...
    "mono-luxe": {
      ...
      badge: "border-slate-300 bg-white/96 text-slate-900 shadow-[0_10px_24px_rgba(15,23,42,0.08)] dark:border-white/10 dark:bg-[#0f172a] dark:text-slate-100",
    ...
    playful: {
      ...
      badge: "border-emerald-100 bg-white/96 text-emerald-800 shadow-[0_10px_24px_rgba(20,83,45,0.07)] dark:border-emerald-500/20 dark:bg-[#0b2417] dark:text-emerald-100",
    ...
    "dark-pro": {
      ...
      badge: "border-slate-300 bg-white/96 text-slate-800 shadow-[0_10px_24px_rgba(15,23,42,0.08)] dark:border-white/10 dark:bg-[#0f172a] dark:text-slate-100",
