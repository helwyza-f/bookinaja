      ...
      >
        ...
        <div className="flex items-center gap-2 md:gap-6 group cursor-pointer">
          ...
          <div className="flex flex-col leading-none">
            <span className="font-[1000] uppercase italic tracking-tighter text-sm md:text-2xl text-slate-950 dark:text-white truncate max-w-[100px] sm:max-w-[140px] md:max-w-none md:pr-3">
              {profile.name}
            </span>
            <div className="flex items-center gap-1.5 md:gap-2 mt-1">
              <div
                ...
                style={{ backgroundColor: primaryColor }}
              />
              <span className="text-[8px] md:text-[10px] font-black uppercase tracking-[0.2em] md:tracking-[0.3em] opacity-60 text-slate-600 dark:text-slate-400 truncate max-w-[80px] md:max-w-none">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <Link href="/admin/login">
            <Button
              className="rounded-xl md:rounded-2xl font-black text-[10px] md:text-xs uppercase tracking-[0.16em] h-10 md:h-12 px-2.5 md:px-6 transition-all active:scale-95 shadow-lg border-none text-white"
              style={{
