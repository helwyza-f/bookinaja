...
export function PageBuilderStudioHeader({
  ...
  return (
    <section className="rounded-2xl border border-slate-200/90 bg-white px-4 py-3 shadow-sm dark:border-white/12 dark:bg-[#0f0f17]">
        ...
        <div className="flex flex-wrap gap-2 xl:justify-end">
          {previewUrl ? (
            <Button
              asChild
              variant="outline"
              className="h-9 rounded-xl border-slate-200 bg-white text-slate-700 hover:bg-slate-50 dark:border-white/10 dark:bg-white/[0.04] dark:text-slate-100 dark:hover:bg-white/[0.08]"
            >
            ...
            <Button type="button" variant="outline" disabled className="h-9 rounded-xl">
              <ExternalLink className="mr-2 h-4 w-4" />
              Publik
            </Button>
          )}
          ...
          <Button
            ...
            className="h-9 rounded-xl border-amber-200 bg-amber-50 text-amber-800 hover:bg-amber-100 dark:border-amber-500/20 dark:bg-amber-500/10 dark:text-amber-100 dark:hover:bg-amber-500/15"
          >
          ...
          <Button
            ...
            onClick={onPublish}
            disabled={saving}
            className="h-9 rounded-xl bg-[var(--bookinaja-600)] px-4 text-white hover:bg-[var(--bookinaja-700)] disabled:border disabled:border-slate-200 disabled:bg-slate-100 disabled:text-slate-400 disabled:opacity-100 dark:disabled:border-white/10 dark:disabled:bg-white/[0.08] dark:disabled:text-slate-500"
          >
