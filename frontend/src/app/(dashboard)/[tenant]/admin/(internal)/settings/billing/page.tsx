    ...
    <div className="space-y-4 p-4 pb-20 sm:space-y-6 sm:p-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="flex flex-col gap-2 sm:flex-row">
          ...
          <Button asChild className="gap-2 bg-[var(--bookinaja-600)] text-white hover:bg-[var(--bookinaja-700)]">
      ...
      {loading ? (
        ...
        <>
          <Card className="relative overflow-hidden border-slate-200 bg-white p-5 shadow-sm dark:border-white/15 dark:bg-[#0f0f17] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] sm:p-7">
            ...
            <div className="relative flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
              <div className="space-y-4">
                <div className="flex flex-wrap items-center gap-2">
                  <Badge variant="outline" className="border-[color:rgba(59,130,246,0.2)] bg-[var(--bookinaja-50)] text-[var(--bookinaja-700)] dark:bg-[color:rgba(59,130,246,0.14)] dark:text-[var(--bookinaja-200)]">
                    Subscription
                  </Badge>
                  ...
                  {isPro && <Badge className="border-none bg-[var(--bookinaja-600)] text-white">Pro</Badge>}
                </div>
          ...
          <div className="grid gap-4 xl:grid-cols-[1.05fr_0.95fr]">
            <Card className="border-slate-200 bg-white p-4 shadow-sm dark:border-white/15 dark:bg-[#0f0f17] sm:p-6">
              <div className="flex items-center justify-between gap-3">
                ...
                <CreditCard className="h-5 w-5 text-[var(--bookinaja-600)] dark:text-[var(--bookinaja-200)]" />
              </div>
            ...
            <Card className="border-slate-200 bg-white p-4 shadow-sm dark:border-white/15 dark:bg-[#0f0f17] sm:p-6">
              <div className="flex items-center justify-between gap-3">
                ...
                <Zap className="h-5 w-5 text-[var(--bookinaja-600)] dark:text-[var(--bookinaja-200)]" />
              </div>
          ...
          <Card id="invoice-history" className="border-slate-200 bg-white p-4 shadow-sm dark:border-white/15 dark:bg-[#0f0f17] sm:p-6">
            <div className="flex items-center gap-3">
              <History className="h-4 w-4 text-slate-400" />
              <h3 className="text-lg font-semibold text-slate-950 dark:text-white">Riwayat invoice</h3>
            </div>
...
function InfoCard({
  ...
  return (
    <Card className="border-slate-200 bg-white p-4 shadow-sm dark:border-white/15 dark:bg-[#0f0f17]">
...
function QuickAction({
  ...
  return (
    <Link href={href} className="group rounded-2xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:bg-slate-100 dark:border-white/10 dark:bg-white/[0.04] dark:hover:bg-white/[0.08]">
