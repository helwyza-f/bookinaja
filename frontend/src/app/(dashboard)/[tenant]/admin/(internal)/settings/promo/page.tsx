...
export default function PromoSettingsPage() {
  ...
  return (
    <div className="space-y-4 p-4 pb-20 sm:space-y-6 sm:p-6">
      <Card className="overflow-hidden rounded-xl border-slate-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#0b0b0b]">
        <div className="border-b border-slate-100 p-5 dark:border-white/5">
          <div className="flex items-start justify-between gap-4">
            <div className="space-y-2">
              <div className="inline-flex items-center gap-2 rounded-md bg-sky-50 px-2.5 py-1 text-[11px] font-medium uppercase tracking-[0.18em] text-sky-700 dark:bg-sky-500/10 dark:text-sky-200">
            ...
            <Button
              ...
              className="rounded-lg bg-[var(--bookinaja-600)] text-white hover:bg-[var(--bookinaja-700)]"
            >
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="h-10 w-full rounded-lg border border-slate-200 bg-white pl-10 pr-4 text-sm outline-none transition focus:border-sky-300 dark:border-white/10 dark:bg-white/[0.03]"
              />
            </div>
          ...
          {loading ? (
            ...
            filteredItems.map((item) => (
              <div
                ...
                className="w-full rounded-lg border border-slate-200 bg-slate-50/60 p-4 text-left transition-colors hover:border-sky-200 dark:border-white/10 dark:bg-white/[0.03]"
              >
...
function Metric({
  ...
  const tones = {
    slate: "bg-slate-50 text-slate-800 dark:bg-white/[0.03] dark:text-slate-100",
  ...
  return (
    <div className={cn("rounded-lg border border-slate-200 p-4 dark:border-white/10", tones[tone])}>
